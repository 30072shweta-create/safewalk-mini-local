 ...
 * This class configures the Telegram Bot beans conditionally based on properties.
 */
@Configuration
 ...
 */
    ...
    /**
     * Creates the TelegramBotsApi bean if the bot is enabled and polling is disabled (webhook mode).
     */
    @Bean
@ConditionalOnExpression("${telegram.bot.enabled:true} && !${telegram.polling.enabled:false}")
